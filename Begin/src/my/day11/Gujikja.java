...
public class Gujikja {
	...
	String passwd;	  // 암호
	String name;      // 성명
	String birthday;  // 생년월일(예: 19960326)
	int gender;       // 성별 "남"--1, "여"--2   //** 유효성검사  "개발자가 유추할 수 있는 데이터 값은 반드시 코드화 해라!!!" **//
	String address;	  // 주소
	int school;	      // 학력 "대졸이상"--1, "초대졸"--2, "고졸"--3, "고졸미만"--4  //** 코드화!!!! **//
	String mobile;    // 휴대폰번호
	String hopejob;   // 희망직종("사무직", "생산직", "일용직"...)
	int hopemoney;    // 희망급여
	
	
	public Gujikja() {count++;} // 기본생성자
