...
public class MainThread {
	...
	public static void main(String[] args) {
		...
		Thread thr = Thread.currentThread(); // 현재 실행중인 스레드객체를 얻어온다
		
		System.out.println("현재 실행중인 스레드이름 : "+thr.getName());//현재 실행중인 스레드 이름을 얻어온다.
		//현재 실행중인 스레드이름 : main
		
		System.out.println("현재 실행중인 스레드의 우선순위 : "+thr.getPriority());//스레드의 우선순위를 알아온다.
		//현재 실행중인 스레드의 우선순위 : 5
		
		System.out.println("스레드가 가질 수 있는 우선순위 최대값 : "+Thread.MAX_PRIORITY);//스레드가 가질 수 있는 우선순위 최대값
		//스레드가 가질 수 있는 우선순위 최대값 : 10
		
		System.out.println("스레드가 가질 수 있는 우선순위 최소값 : "+Thread.MIN_PRIORITY);//스레드가 가질 수 있는 우선순위 최소값
		//스레드가 가질 수 있는 우선순위 최소값 : 1
		
		System.out.println("스레드에게 부여된 우선순위 기본값 : "+Thread.NORM_PRIORITY);//스레드에게 부여된 우선순위 기본값
		//스레드에게 부여된 우선순위 기본값 : 5
