...
public class InitialBlockTest {
	...
	*/
	static { // 클래스 초기화 블럭
		System.out.println("== InitialBlockTest 의 클래스 초기화 블럭 실행함 ==");
		point = 10;
	}
	 ...
	 */
	{
		System.out.println(">> InitialBlockTest 의 인스턴스 초기화 블럭 실행함 <<");
		name = "두석규";
	}
	...
	public InitialBlockTest(String userid, String pwd, String name) {
		...
		this.pwd = pwd;
		this.name = name;
		System.out.println("== 인자가 있는 생성자 실행함 ==");
	...
	public static void main(String[] args) {
		...
		InitialBlockTest obj1 = new InitialBlockTest();		//인스턴스 생성 -->인스턴스 초기화 블럭 실행 --> 기본생성자 실행
		
		InitialBlockTest obj2 = new InitialBlockTest();		
		
		InitialBlockTest obj3 = new InitialBlockTest("irin","1234","아이린");		
		//인스턴스 생성--> 인스턴스 초기화 블럭 실행 --> 인자가 있는 생성자 실행 
