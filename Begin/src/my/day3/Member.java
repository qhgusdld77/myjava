...
public class Member {
	...
	static int count;	//count는 Member 클래스로 생성되어진 객체의 갯수를 누적시키는 용도로 써보겠다.
	...
	public void showInfo() {
		...
		System.out.println("1. 암  호 :" + pwd);
		System.out.println("1. 성  명 :" + name);
		System.out.println("1. 나  이 :" + age);
	...
	// == 리턴타입(반환타입)은 없고 매개변수(인자, 파라미터)가 있는 인스턴스 메소드 생성하기 == //
	public void chageVal(String pwd, int age) {
		this.pwd = pwd;
		this.age = age;
	}	
	
	// ==  리턴타입(반환타입)은 있고 매개변수(인자, 파라미터)도 있는 인스턴스 메소드 생성하기 == //
