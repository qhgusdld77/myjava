...
public class PrimitiveTypeTest {
	...
	//	int it2 = 10000000000000;	//표현가능한 범위를 넘었으므로 오류.
		...
		// float 형태로 나타내기 위해서는 숫자 뒤에  f 나  F 를 붙여야한다.
	...
	public char changeToUpperCase(char b) {
		return (char)(b-32);
	}
