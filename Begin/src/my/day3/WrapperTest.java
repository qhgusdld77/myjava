...
public class WrapperTest {
	...
	public static void main(String[] args) {
		...
		boolean bool = Character.isLowerCase(ch); //소문자이면 참
		...
		bool = Character.isUpperCase('B');	//대문자 이면 참
		System.out.println(bool);
		//true
		...
		bool = Character.isDigit('3');	//숫자모양이면 참 아니면 거짓
		System.out.println(bool);
		//true
		...
		System.out.println(bool);
		//true																	=======> Character 글자를 검사할때 쓰임  (반환형 boolean)
		...
		System.out.println("age + n => " +(Integer.parseInt(age)+n));	//문자열(String)로 되어진 숫자를 int로 바꾸줌
		//age + n => 27
		
		System.out.println("age + n => " +(Byte.parseByte(age)+n));		//위에꺼랑 표현범위만 다르다
		//age + n => 27
		
		System.out.println("age + n => " +(Short.parseShort(age)+n));	//표현범위만 다름
		//age + n => 27
		
		System.out.println("age + n => " +(Long.parseLong(age)+n));		//표현범위만 다름(리턴값을 long으로)
		//age + n => 27
		...
		System.out.println("point + 2 => "+(Integer.toString(point))+2);		//많이 쓴다 외워라~~~
		//point + 2 => 982
		
		System.out.println("point + 2 => "+(String.valueOf(point))+2);			//많이 쓴다 외워라~~~
		//point + 2 => 982
