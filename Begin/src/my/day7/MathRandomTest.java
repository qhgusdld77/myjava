	...
	*/
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.print("\n1 부터 10까지중 랜덤하게 발생한 값 : ");
	//	System.out.println((int)(Math.random()*(10-1+1))+1);
		System.out.println(MyUtil.random(1,10));//클래스명.메소드 // static 메소드
		
		System.out.println("");
		System.out.print("13 부터 18까지중 랜덤하게 발생한 값 : ");
		System.out.println(MyUtil.random(3,18));//클래스명.메소드 // static 메소드
		
		System.out.println("");
		System.out.print("a 부터 z까지중 랜덤하게 발생한  소문자 : ");
		System.out.println((char)MyUtil.random('a','z'));//random메소드에서 int로 받아서 int로 돌려주니까 (char)으로 문자로 바꿔줌 
