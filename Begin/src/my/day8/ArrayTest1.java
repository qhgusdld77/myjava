...
public class ArrayTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("평균 : "+Math.round((double)total/7*10)/10.0);//소수첫째자리까지 반올림
		...
		// 2). 메모리에 할당을 해준다.
		subject = new int[7]; //배열도 객체이다!!!!! new
		
		// 배열로 선언된 변수에는 자동적으로 초기값이 들어가 있다.
		// 정수는 0, 실수는 0.0, char는  ' ', String 을 포함한 객체는 null이 들어간다.
		...
		*/
		...
		System.out.println("배열 subject 의 길이 : " + subject.length/*배열의 길이 나옴*/);
		//배열 subject 의 길이 : 7
		...
		*/
		...
		System.out.println("총점 : "+ total);
		System.out.println("평균 : "+Math.round((double)total/subject.length*10)/10.0);//소수첫째자리까지 반올림
		
		System.out.println("\n=======================================");
		
		/*
		 	위의  1). 배열의 선언   int[] subject; subject = new int[7];
		...
		*/
		...
		int[] course2 = /*new int[] 생략가능하다*/ {100, 90, 95, 70, 98, 100,90};
		...
		*/								 	
		...
		total = 0;
		for(int jumsu :course2) { //베열의 갯수만큼 반복 
