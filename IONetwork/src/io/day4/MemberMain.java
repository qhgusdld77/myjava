...
public class MemberMain {
	...
	//------------------------------------------- 나의정보변경 -------------------------------------------------------------//
	public static void changeinfo(Member mem, Scanner sc) {
		System.out.print(">> 암호 :");
	...
	public static void main(String[] args) {
		...
		do {
			...
			case "1"://회원가입
				...
				break;
			case "2"://로그인
				loginMember = MemberMain.login(memList, sc);
				break;
			case "3"://모든회원출력
				for(Member mem : memList) {
			...
			case "6"://나의정보변경
				if(loginMember != null) {
					MemberMain.changeinfo(loginMember, sc);
					serial.objectToFileSave(memList, savefilename);
				}
